 ...
 * @author sed1
 */
public class verSolucionInvitado extends javax.swing.JFrame {

    /**
     * Creates new form verSolucionInvitado
     */
    public verSolucionInvitado() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        verEjercicioInvitado vent = new verEjercicioInvitado();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(verSolucionInvitado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new verSolucionInvitado().setVisible(true);
            }
        });
    }
